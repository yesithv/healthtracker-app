          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                // Terciario: la ÚNICA entrada sin cuenta que se admite es la
                // demostración —datos ficticios en una base aparte, borrados al
                // salir— y se entra por enterDemo(), no por un atajo al panel.
                TextButton(
                  onPressed: () => enterDemo(context),
                  child: Text(
                    l10n.introDemo,
                    style: TextStyle(
