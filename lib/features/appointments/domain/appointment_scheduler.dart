...
class AppointmentScheduler {
  ...
  static NotificationText _defaultScheduledText(Appointment a) =>
      (title: 'Cita: ${a.title}', body: 'Tienes una cita próximamente.');

  static NotificationText _defaultToBookText(Appointment a) => (
        title: 'Saca tu cita: ${a.title}',
        body: 'Es momento de agendar esta cita.',
      );

  static NotificationText _defaultOverdueText(Appointment a) => (
        title: 'Cita pendiente: ${a.title}',
        body: 'Tienes una cita vencida por atender.',
      );
}
