...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get helpLegalDescription =>
      'Un riassunto di come funziona l\'app. I termini e l\'informativa completi li serve il server, e sono quelli che fanno fede.';
  ...
  String get helpFaqA2 =>
      'Sì. Le tue misurazioni restano sul telefono e vengono copiate sul nostro server quando c\'è connessione. È ciò che ti permette di non perdere lo storico cambiando telefono, e ciò che consente al personale della clinica nutrizionale associata di seguire il tuo andamento, se sei loro paziente. Puoi scaricare tutto o eliminare il tuo account dalle Impostazioni.';
  ...
  String get helpLegalPurposeBody =>
      'My Vitals HealthTracker è un\'applicazione per registrare e seguire i tuoi indicatori di salute. Se sei paziente della clinica nutrizionale associata, puoi anche consultare lì la tua cartella. Non è un dispositivo medico certificato.';
  ...
  @override
  String get helpLegalPrivacyTitle => 'I tuoi dati e dove si trovano';

  @override
  String get helpLegalPrivacyBody =>
      'Le tue misurazioni restano sul telefono e vengono copiate sul nostro server quando c\'è connessione: è ciò che ti permette di non perdere lo storico cambiando telefono. Hai un account, identificato dalla tua email. Puoi scaricare tutto ciò che abbiamo su di te da la sezione «Backup» delle Impostazioni, ed eliminare il tuo account da la sezione «Account».';
  ...
  String get helpLegalContactBody =>
      'Per questioni legali o di privacy, scrivi a: yesithvalencia@gmail.com';
  ...
  String get backupPrivacyBody =>
      'I tuoi dati sanitari vivono in due posti: sul telefono, perché l\'app funzioni anche senza connessione, e sul nostro server, perché tu non li perda cambiando telefono.\n\nPuoi bloccare l\'app con l\'impronta o il volto da Impostazioni, sezione «Privacy». Non vendiamo i tuoi dati né li cediamo a fini commerciali. Li vede il personale autorizzato della clinica nutrizionale associata, se sei loro paziente, e nessun altro.';
  ...
  @override
  String get serverExportTitle => 'Scarica tutti i miei dati';

  @override
  String get serverExportSubtitle =>
      'Tutto ciò che la clinica conserva su di te, inclusa la tua storia precedente, in un file';

  @override
  String get serverExportButton => 'Scarica';

  @override
  String get serverExportSuccess => 'I tuoi dati sono stati scaricati.';

  @override
  String get serverExportNeedsSession => 'Accedi per scaricare i tuoi dati.';
  ...
  @override
  String get dashboardViewHistory => 'Vedi cronologia';
  ...
  String get profileUnavailable =>
      'Non siamo riusciti ad aprire il tuo profilo. Riprova tra poco.';
  ...
  @override
  String get medicationsMenuTitle => 'Farmaci';

  @override
  String get medicationAdd => 'Aggiungi farmaco';

  @override
  String get medicationTaken => 'Assunto';

  @override
  String get medicationSkipped => 'Saltato';

  @override
  String get medicationRefill => 'Rifornisci';

  @override
  String medicationDoseNotifTitle(String name) {
    return 'È ora di $name';
  }

  @override
  String get medicationDoseNotifBody => 'È ora della tua dose.';

  @override
  String medicationRefillNotifTitle(String name) {
    return 'Rifornisci $name';
  }

  @override
  String get medicationRefillNotifBody => 'Le tue scorte stanno per esaurirsi.';

  @override
  String medicationUnitsLeft(int count) {
    return '$count unità rimaste';
  }

  @override
  String get medicationOutOfStock => 'Esaurito';

  @override
  String get medFormNameCapsule => 'Capsula';

  @override
  String get medFormNameTablet => 'Compressa';

  @override
  String get medFormNameLiquid => 'Liquido';

  @override
  String get medFormNameInjection => 'Iniezione';

  @override
  String get medFormNameDrops => 'Gocce';

  @override
  String get medFormNameOther => 'Unità';
  ...
  @override
  String get medScheduleDaily => 'Tutti i giorni';
  ...
  String get medMenuDescription =>
      'Gestisci le tue dosi, il tuo inventario e la tua aderenza in un unico posto.';
  ...
  String medMenuTodaySubtitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count dosi in sospeso',
      one: '1 dose in sospeso',
      zero: 'Nessuna dose in sospeso',
    );
    return '$_temp0';
  }
  ...
  String medMenuInventorySubtitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count in esaurimento',
      one: '1 in esaurimento',
      zero: 'Tutto in scorta',
    );
    return '$_temp0';
  }
  ...
  String medMenuAdherenceSubtitle(int pct, int streak) {
    return '$pct% questo mese · $streak giorni di fila';
  }

  @override
  String get medTodayTitle => 'Oggi';

  @override
  String get medTodayDescription =>
      'Registra le dosi di oggi e rivedi ciò che è fatto.';

  @override
  String get medSectionToTakeToday => 'DA PRENDERE OGGI';

  @override
  String get medSectionLogged => 'REGISTRATO';

  @override
  String get medSectionYourMeds => 'I TUOI FARMACI';
  ...
  @override
  String get medNoPendingToday => 'Nessuna dose rimasta per oggi.';
  ...
  String get medInventoryDescription =>
      'Quante unità ti restano e quando conviene rifornire.';
  ...
  @override
  String get medAdherenceTitle => 'Aderenza';

  @override
  String get medAdherenceDescription =>
      'La tua costanza con la terapia durante il mese.';

  @override
  String medComplianceMonth(String month) {
    return 'aderenza · $month';
  }

  @override
  String get medStreakDays => 'giorni di fila';

  @override
  String get medLegendTaken => 'Presa';

  @override
  String get medLegendSkipped => 'Saltata';

  @override
  String get medLegendNoData => 'Nessun dato';

  @override
  String get medSectionSchedule => 'SCHEMA';

  @override
  String get medSectionAdherence => 'ADERENZA';

  @override
  String get medSectionInformation => 'INFORMAZIONI';
  ...
  String medBuyBefore(String date) {
    return 'Compra entro il $date';
  }

  @override
  String medPackAndThreshold(int pack, int threshold) {
    return 'Confezione da $pack · avviso a: $threshold';
  }

  @override
  String get medThisMonth => 'questo mese';

  @override
  String get medEdit => 'Modifica';
  ...
  String get medDeleteBody =>
      'Verranno eliminati il farmaco e tutta la sua cronologia. L\'azione non può essere annullata.';

  @override
  String get medInfoSoon => 'Presto';

  @override
  String get medInfoSoonBody => 'Interazioni, gravidanza e allattamento.';

  @override
  String get medRegisterDose => 'Registra dose';

  @override
  String medDoseAtTime(String amount, String time) {
    return '$amount alle $time';
  }

  @override
  String get medSkip => 'Salta';

  @override
  String medMultipleTitle(int count, String time) {
    return '$count dosi alle $time';
  }

  @override
  String get medMultipleSubtitle =>
      'Segna ciascuna o registrale tutte insieme.';

  @override
  String get medSkipRest => 'Salta il resto';
  ...
  @override
  String get medNotifTitle => 'Attiva i promemoria';

  @override
  String get medNotifBody =>
      'Ti avvisiamo all\'ora di ogni dose e quando le scorte stanno per finire. Puoi cambiarlo quando vuoi.';

  @override
  String get medNotifWebWarning =>
      'Le notifiche non sono disponibili nella versione web. Usa l\'app per iOS o Android.';

  @override
  String get medAllowNotifications => 'Consenti le notifiche';

  @override
  String get medNotNow => 'Non ora';
  ...
  @override
  String get medBack => 'Indietro';

  @override
  String get medStepIdentity => 'Identità';

  @override
  String get medStepDose => 'Dose';

  @override
  String get medStepFrequency => 'Frequenza';

  @override
  String get medStepDates => 'Date';
  ...
  @override
  String get medFieldStrength => 'DOSAGGIO';

  @override
  String get medFieldColorIcon => 'COLORE E ICONA';

  @override
  String get medShapeCapsule => 'Capsula';

  @override
  String get medShapeRound => 'Rotonda';

  @override
  String get medFieldReason => 'PER COSA (FACOLTATIVO)';

  @override
  String get medFieldQtyPerDose => 'QUANTITÀ PER DOSE';

  @override
  String get medWithFood => 'Prendi con il cibo';

  @override
  String get medWithFoodSub => 'Suggerimento nel promemoria';

  @override
  String get medSpecialInstruction => 'Istruzione speciale';

  @override
  String get medSpecialInstructionSub => 'Es. sciogliere in acqua';

  @override
  String get medFreqDaily => 'Giornaliero';

  @override
  String get medFreqSpecificDays => 'Giorni specifici';

  @override
  String get medFreqEveryNDays => 'Ogni N giorni';

  @override
  String get medFieldWeekdays => 'GIORNI DELLA SETTIMANA';

  @override
  String get medFieldDoseTimes => 'ORARI DELLE DOSI';

  @override
  String get medAddTime => 'Aggiungi orario';

  @override
  String get medIntervalLabel => 'Ogni quanti giorni';

  @override
  String get medFieldStart => 'INIZIO';

  @override
  String get medWithEndDate => 'Con data di fine';

  @override
  String get medWithEndDateSub => 'Termina la terapia in una data';

  @override
  String get medFieldEnd => 'FINE';

  @override
  String get medTrackInventory => 'Gestisci l\'inventario';

  @override
  String get medTrackInventorySub => 'Scala le scorte a ogni dose';

  @override
  String get medCurrentUnits => 'Unità attuali';

  @override
  String get medAlertWhenRemaining => 'Avvisami quando restano';

  @override
  String get medLeadTimeDays => 'Anticipo (giorni)';

  @override
  String get medPackSize => 'Dimensione confezione';

  @override
  String get medRefillAlerts => 'Avvisi di riacquisto';

  @override
  String get medRefillAlertsSub => 'Con scadenza stimata';

  @override
  String get medSaveMedication => 'Salva farmaco';

  @override
  String get medContinue => 'Continua';

  @override
  String get medErrorNameRequired => 'Inserisci un nome';

  @override
  String get medErrorSelectDays => 'Scegli almeno un giorno';
  ...
  @override
  String get medRefillTitle => 'Rifornisci l\'inventario';
  ...
  String medRunsOutInDays(int days) {
    ...
    return 'Finisce tra ~$_temp0';
  }

  @override
  String get medAddABox => 'Aggiungi una confezione';

  @override
  String get medAddABoxSub => 'Si somma alle scorte attuali';

  @override
  String medWillRemain(int units, int days) {
    return 'Resteranno $units unità · durano ~$days giorni';
  }

  @override
  String get medRemindOneDay => 'Ricordamelo tra 1 giorno';

  @override
  String get medBought => 'L\'ho comprato';

  @override
  String get medEmptyTitle => 'Ancora nessun farmaco';

  @override
  String get medEmptyBody =>
      'Aggiungi il tuo primo farmaco e ti ricorderemo ogni dose e ti avviseremo prima che finisca.';

  @override
  String get medDashTodayLabel => 'DOSI DI OGGI';

  @override
  String get medDashSeeModule => 'Vedi modulo ›';

  @override
  String get medDashNextDose => 'Prossima dose';

  @override
  String get medDashNoDoses => 'Nessuna dose in arrivo';

  @override
  String medLowStockBannerTitle(String name, int count) {
    return 'A $name restano $count unità';
  }

  @override
  String get medDashMedsTitle => 'Farmaci';
  ...
  @override
  String get medDashAllDone => 'Tutto in regola';

  @override
  String get medDashAddMed => 'Aggiungi';

  @override
  String medDashLowShort(int count) {
    return 'Restano $count';
  }
  ...
  @override
  String get appointmentsSectionToBook => 'Da prenotare';

  @override
  String get appointmentsSectionScheduled => 'Prenotate';

  @override
  String get appointmentsSectionHistory => 'Cronologia';
  ...
  String appointmentDueOn(String date) {
    return 'Prenota entro il $date';
  }

  @override
  String get appointmentNoDate => 'Senza data';
  ...
  @override
  String get appointmentStatusAttended => 'Effettuata';

  @override
  String get appointmentStatusMissed => 'Mancata';

  @override
  String get appointmentStatusCancelled => 'Annullata';

  @override
  String get appointmentActionBook => 'Ho prenotato';

  @override
  String get appointmentActionPostpone => 'Rinvia';

  @override
  String get appointmentActionAttended => 'Ci sono andato';

  @override
  String get appointmentActionMissed => 'Non ci sono andato';

  @override
  String get appointmentActionDelete => 'Elimina';

  @override
  String get appointmentDeleteTitle => 'Eliminare questa visita?';

  @override
  String get appointmentAddTitle => 'Nuova visita';

  @override
  String get appointmentModeToBook => 'Devo prenotarla';

  @override
  String get appointmentModeScheduled => 'Ho già la data';

  @override
  String get appointmentFieldTitle => 'Titolo';

  @override
  String get appointmentFieldTitleHint => 'Es. Controllo endocrinologico';

  @override
  String get appointmentFieldSpecialty => 'Specialità';
  ...
  @override
  String get appointmentFieldTargetDate => 'Data entro cui prenotare';

  @override
  String get appointmentFieldProvider => 'Medico o luogo';

  @override
  String get appointmentFieldNotes => 'Note';

  @override
  String get appointmentPickDate => 'Scegli data';

  @override
  String get appointmentPickTime => 'Scegli ora';

  @override
  String get appointmentTitleRequired => 'Inserisci un titolo per la visita';

  @override
  String get appointmentDateRequired => 'Scegli una data';

  @override
  String get appointmentSave => 'Salva';

  @override
  String get apptDashAdd => 'Aggiungi visita';

  @override
  String get apptDashNextTitle => 'Prossima visita';

  @override
  String get apptDashToBookTitle => 'Da prenotare';

  @override
  String get apptDashOverdue => 'Scaduta';

  @override
  String get apptDashAllClear => 'Tutto in regola';
  ...
  @override
  String get apptScheduledNotifBody => 'Hai una visita in arrivo.';

  @override
  String apptToBookNotifTitle(String title) {
    return 'Ora di prenotare: $title';
  }

  @override
  String get apptToBookNotifBody => 'Ora di prenotare questa visita.';

  @override
  String apptOverdueNotifTitle(String title) {
    return 'Visita in sospeso: $title';
  }
  ...
  @override
  String get accessDoorTitle => 'Entra con la tua email';

  @override
  String get accessDoorSubtitle =>
      'Ti inviamo un codice di sei cifre. Se non hai ancora un account, con quel codice lo crei.';

  @override
  String get accessDoorEmailLabel => 'Email';

  @override
  String get accessDoorEmailHint => 'nome@email.com';

  @override
  String get accessDoorContinue => 'Continua';

  @override
  String get accessDoorInvalidEmail => 'Inserisci un\'email valida.';

  @override
  String get accessCodeSentTitle => 'Controlla la tua email';

  @override
  String get accessCodeSentSubtitle =>
      'Se quell\'indirizzo può entrare, lì trovi il tuo codice. Scade dopo quindici minuti.';

  @override
  String get accessClinicCodeLink => 'Ho già un codice della clinica';

  @override
  String get signupTitle => 'Completa il tuo account';

  @override
  String get signupSubtitle =>
      'Con questi dati le tue misure si confrontano con gli intervalli che ti corrispondono.';

  @override
  String get signupNameLabel => 'Nome';

  @override
  String get signupDocumentLabel => 'Numero del documento';

  @override
  String get signupDocumentHelp =>
      'Serve a riconoscerti se sei già paziente della clinica.';
  ...
  @override
  String get signupSubmit => 'Crea il mio account';

  @override
  String get signupMissingTerms =>
      'Devi accettare i termini per creare l\'account.';

  @override
  String get callClinicTitle => 'Chiama la clinica';

  @override
  String get callClinicBody =>
      'Quel documento è già registrato. Non consegniamo una cartella clinica senza verificare chi sei: la attiva una persona al telefono.';

  @override
  String get callClinicBack => 'Indietro';

  @override
  String get accessCodeClinicHint =>
      'Chiama la clinica: verificheranno la tua identità e ti detteranno il codice con cui portiamo i tuoi dati.';

  @override
  String get verifyBringingHistory => 'Sto portando la tua storia…';

  @override
  String get legalTitle => 'Termini e privacy';

  @override
  String get legalTermsTab => 'Termini d\'uso';

  @override
  String get legalPrivacyTab => 'Privacy';

  @override
  String get legalAcceptButton => 'Accetto';

  @override
  String get legalDecline => 'Non accetto ed esco';

  @override
  String get legalNotTranslated =>
      'Questo documento non è ancora tradotto nella tua lingua. Viene mostrato in spagnolo, che è la versione che fa fede.';

  @override
  String get legalLoadFailed =>
      'Non è stato possibile caricare il documento. Controlla la connessione.';

  @override
  String get legalAcceptFailed =>
      'Non è stato possibile registrare la tua accettazione. Riprova.';

  @override
  String get legalRetry => 'Riprova';

  @override
  String get legalGateTitle => 'Prima di entrare';
  ...
  @override
  String get helpLegalWhoSeesTitle => 'Chi può vedere la tua cartella';

  @override
  String get helpLegalWhoSeesBody =>
      'Tu, sempre. E il personale autorizzato della clinica nutrizionale associata, se sei loro paziente: sono chi ti segue e avevano già la tua cartella prima di questa app. Non vendiamo i tuoi dati né li cediamo a fini commerciali.';

  @override
  String get consentsTitle => 'Come vuoi che ti contattiamo';

  @override
  String get consentsDescription =>
      'Sei tu a decidere su quali canali la clinica può scriverti o chiamarti.';

  @override
  String get consentsPhone => 'Telefonate';

  @override
  String get consentsMessages => 'Messaggi (SMS o WhatsApp)';

  @override
  String get consentsEmail => 'Email';

  @override
  String get consentsUnset => 'Non hai ancora risposto';
